...
from tests.test_car_window_scoring import run_car_window_scoring_tests
...
def main():
    ...
    TEST_REGISTRY = [
        ...
        ("car_window_scoring", run_car_window_scoring_tests, "Car charging window scoring diagnostic tests", False),
        ...
        ("car_solar_possible", run_car_solar_possible_tests, "Car solar diversion opportunity tests", False),
